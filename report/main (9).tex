...
\title{Wealth, Residence, and Maternal Age as Determinants of Infant Mortality: A Comparative Analysis of Himachal Pradesh and Mizoram (NFHS-5)}
\author{Prepared by ChatGPT Analysis Assistant}
\date{\today}
\maketitle

\begin{abstract}
This report investigates the relationship between socioeconomic and demographic factors and infant mortality in the Indian states of Himachal Pradesh and Mizoram, using data from the National Family Health Survey (NFHS-5). The analysis focuses on three explanatory variables: household wealth, maternal age, and place of residence. Standard logistic regression and rare-event corrected models were used to estimate associations between these predictors and the probability of infant death. Results reveal that wealth has a significant negative effect on infant mortality in Himachal Pradesh, while in Mizoram the relationship is weaker, likely due to lower socioeconomic inequality and strong community-level healthcare. Maternal age and residence type show limited explanatory power once rare-event bias and clustering are accounted for. These findings underscore the importance of social equality and accessible public health systems in mitigating infant mortality.
\end{abstract}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{wealth_vs_imr_plot.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{residence_imr_plot.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{mother_age_imr_plot.png}
...
\vspace{1em}
\noindent \textbf{Keywords:} Infant Mortality, NFHS-5, Rare Event Logistic Regression, Wealth Index, Maternal Age, Himachal Pradesh, Mizoram

\bibliographystyle{apalike}
\begin{thebibliography}{9}
\bibitem[King and Zeng, 2001]{king2001} King, G., and Zeng, L. (2001). ``Logistic regression in rare events data.'' \emph{Political Analysis}, 9(2): 137--163.
\bibitem[NFHS-5, 2021]{nfhs5} International Institute for Population Sciences (IIPS) and ICF. (2021). \emph{National Family Health Survey (NFHS-5), 2019–21: India}. Mumbai: IIPS.
\end{thebibliography}

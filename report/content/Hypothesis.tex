...
Let $IMR$ denote the infant mortality outcome (binary at child level, or rate per 1000 live births at aggregate level), $W$ the household wealth index (continuous or quintile), $A$ the mother's age (years or age group), $R$ the residence type (urban/rural), $E$ the mother's education level (years of schooling or categorical), and $C$ the number of children ever born (or average children per woman). Subscripts $MZ$ and $HP$ denote Mizoram and Himachal Pradesh respectively.

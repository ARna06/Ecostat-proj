...
\section{Hypotheses}
\subsection{Household wealth in relation to infant mortality individually}
\paragraph{$H_0$ (null)} Higher household wealth has no association with infant mortality.
\paragraph{$H_1$ (alternate)} Higher household wealth is associated with lower infant mortality.

\subsection{Infant mortality in relation to residence type individually}
\paragraph{$H_0$ (null)} Infant mortality rates do not differ between urban and rural residences.
\paragraph{$H_1$ (alternate)} Infant mortality rates differ between urban and rural residences, with rural areas having higher rates.

\subsection{Infant mortality in relation to age of the mother}
\paragraph{$H_0$ (null)} Maternal age has no association with infant mortality.
\paragraph{$H_1$ (alternate)} Maternal age is associated with infant mortality, with higher risk for very young (<20 years).
